...
import { ThemeColors } from '../../../theme';
  ...
  const SeedPhrase = () => {
    ...
    const verificationHandler = () => {
      navigation.navigate('VerifySeed', {"email" : route?.params?.email});
    };
    ...
    return (
      <View style={styles.screen}>
        ...
        <View style={styles.view2}>
            ...
            uncheckedCheckBoxColor={ThemeColors.textPrimary}
            />
            <Text style={styles.checkText}>Yes, I have saved it securely.</Text>
            </View>
