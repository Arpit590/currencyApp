  ...
  return (
    <View style={styles.screen}>
        <View style={styles.view}>
            ...
            <Text style={styles.text}>An email with a verification link and code has been sent to {route?.params?.email}</Text>
        ...
        <View style={styles.view2}>
            <PrimaryButton
            title="Verify"
            buttonHandler={verificationHandler}
            />
            <TouchableOpacity
      ...
      >
        <View style={styles.modal}>
            <Text style={[styles.help, {color:"#BBBAB3", textAlign:"left"}]}>Need Help ?</Text>
            <View style={{marginTop:30}}>
                ...
                activeOpacity={0.8} style={styles.container}>
                    <ResetIcon/>
                    <Text style={[styles.containerText, {marginLeft:15}]}>Reset</Text>
                </TouchableOpacity>
            </View>
        </View>
      </ModalView>
