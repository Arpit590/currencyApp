      ...
      <View style={styles.view1}>
          <ScrollView showsVerticalScrollIndicator={false} style={{alignSelf:"center", width:width, marginBottom:100}}>
            ...
            style={styles.container}>
              ...
              <TouchableOpacity activeOpacity={0.8} onPress={()=>{navigation.navigate("PassportEditScreen", {"save" : false})}} style={{alignSelf:"center"}}>
                <ArrowRightIcon/>
              </TouchableOpacity>
            </View>
          </ScrollView>
        ...
        activeOpacity={0.8}
        onPress={()=>{
          navigation.navigate("PassportEditScreen", {"new" : true})
        }}
...
export default PassportMainScreen;
