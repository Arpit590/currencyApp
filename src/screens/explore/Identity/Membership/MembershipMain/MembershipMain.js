...
import MembershipIcon from "../../../../../assets/Member.svg"
  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.view1}>
            ...
            style={styles.container}>
              <View style={styles.content}>
                ...
                <View style={{}}>
                    ...
                    <Text style={[styles.contentText, {color:"#94928C", fontSize:FontSizes.normal, marginTop:3}]}>CK 4582842390</Text>
                </View>
              </View>
              <TouchableOpacity activeOpacity={0.8} onPress={()=>{navigation.navigate("MembershipEdit", {"save" : false})}} style={{alignSelf:"center"}}>
                <ArrowRightIcon/>
              </TouchableOpacity>
            </View>
          </ScrollView>
        ...
        activeOpacity={0.8}
        onPress={()=>{
          navigation.navigate("MembershipEdit", {"new" : true})
        }}
