  ...
  return (
    <View style={styles.screen}>
      <View style={styles.view}>
        ...
        <Text style={styles.heading}>{route?.params?.new ? "Tour Visa" : "Satrujit Behera"}</Text>
        <View></View>
      </View>
      <ScrollView showsVerticalScrollIndicator={false} style={styles.view1}>
        ...
        <View style={[styles.formContent, {borderWidth:3, borderColor:"#DBD9D1", borderRadius:10, padding:20, alignItems:"center"}]}>
            <Image
            source={require("../../../../../assets/TourVisaImage.png")}
            style={styles.image}
            />
        </View>
        ...
        <View style={styles.formContent}>
            <Text style={styles.formText}>UID Number</Text>
            <View style={styles.input}>
              <TextInput
        ...
        <View style={styles.formContent}>
            <Text style={styles.formText}>Valid till</Text>
            <View style={styles.input}>
        ...
        <View style={styles.formContent}>
            <Text style={styles.formText}>Place of Issue</Text>
            <View style={styles.input}>
      ...
      <View style={{marginHorizontal:20}}>
        ...
        buttonHandler={()=>{
            if(route?.params?.save===false){
                navigation.navigate("TourVisaEdit", {"save": true})
            }else{
                navigation.goBack()
            }
        }}
