    ...
    <View style={styles.screen}>
      <View style={styles.viewContainer}>
        <View style={styles.view}>
            ...
            <Text style={styles.heading}>Medical</Text>
            <View></View>
        </View>
      ...
      <View style={styles.view1}>
          <ScrollView showsVerticalScrollIndicator={false} style={{alignSelf:"center", width:width, marginBottom:100}}>
            ...
            style={styles.container}>
              <View style={styles.content}>
                ...
                <View style={{}}>
                    <Text style={styles.contentText}>12/06/22</Text>
                </View>
              </View>
              <TouchableOpacity activeOpacity={0.8} onPress={()=>{navigation.navigate("MedicalEdit", {"save": false})}} style={{alignSelf:"center"}}>
                <ArrowRightIcon/>
              </TouchableOpacity>
            </View>
          </ScrollView>
        ...
        activeOpacity={0.8}
        onPress={()=>{
            navigation.navigate("MedicalEdit", {"new": true})
        }}
