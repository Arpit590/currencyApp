...
import ImagesIcon from "../../../../../assets/ImageIcon.svg"
          ...
          <ScrollView showsVerticalScrollIndicator={false} style={{alignSelf:"center", width:width, marginBottom:100}}>
            ...
            style={styles.container}>
              <View style={styles.content}>
                ...
                />
                <View style={{}}>
                    <Text style={styles.contentText}>Sahsagjs.jpg</Text>
                </View>
              </View>
              <TouchableOpacity activeOpacity={0.8} onPress={()=>{navigation.navigate("ImagesView")}} style={{alignSelf:"center"}}>
                <ArrowRightIcon/>
              </TouchableOpacity>
            </View>
          </ScrollView>
