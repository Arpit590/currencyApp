  ...
  return (
    <View style={styles.screen}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.view1}>
        ...
        <View style={styles.formContent}>
            <Text style={styles.formText}>Insurance ID</Text>
            <View style={styles.input}>
              <TextInput
        ...
        <View style={styles.formContent}>
            <Text style={styles.formText}>Upload Insurance Document</Text>
            <TouchableOpacity activeOpacity={0.8} style={styles.cameraContainer}>
                <Text style={styles.cameraText}>Click here to upload insurance document</Text>
            </TouchableOpacity>
        </View>
      </ScrollView>
