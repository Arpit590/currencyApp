  ...
  return (
    <View style={styles.screen}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.view1}>
        ...
        <View style={styles.formContent}>
            <Text style={styles.formText}>Date of Creation</Text>
            <View style={styles.input}>
        ...
        <View style={styles.formContent}>
            <Text style={styles.formText}>Certification ID</Text>
            <View style={styles.input}>
              <TextInput
        ...
        <View style={styles.formContent}>
            <Text style={styles.formText}>Upload Certificate</Text>
            <TouchableOpacity activeOpacity={0.8} style={styles.cameraContainer}>
                <Text style={styles.cameraText}>Click here to upload Certificate</Text>
            </TouchableOpacity>
        </View>
      </ScrollView>
